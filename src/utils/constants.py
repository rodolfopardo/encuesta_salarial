...
# Áreas funcionales para organizar cargos
AREAS_FUNCIONALES = {
    ...
    'Hospitalidad y Turismo': ['jefe_hospitalidad', 'guia_turismo', 'jefe_alimentos_bebidas',
    ...
    'Operaciones y Producción': ['director_operaciones', 'gerente_planta', 'jefe_produccion',
                                  'ingeniero_procesos', 'supervisor_produccion', 'analista_produccion'],
    'Enología y Agricultura': ['gerente_enologia', 'jefe_bodega', 'supervisor_bodega',
                               'gerente_agricola', 'ingeniero_agronomo', 'supervisor_fincas'],
    'Calidad y Laboratorio': ['jefe_laboratorio', 'analista_laboratorio', 'gerente_calidad',
                              'jefe_calidad', 'analista_calidad', 'tecnico_calidad'],
    'Supply Chain y Logística': ['gerente_supply_chain', 'jefe_planificacion', 'jefe_logistica',
                                  'analista_logistica', 'supervisor_depositos'],
    'Compras': ['gerente_compras', 'jefe_compras', 'comprador_analista'],
    'Mantenimiento': ['gerente_mantenimiento', 'jefe_mantenimiento', 'supervisor_mantenimiento',
                      'tecnico_mantenimiento'],
    'Seguridad e Higiene': ['gerente_seguridad', 'jefe_seguridad', 'tecnico_seguridad'],
    'Proyectos e Ingeniería': ['jefe_ingenieria', 'ingeniero_proyectos', 'asistente_proyecto',
                               'jefe_obra', 'supervisor_obra'],
    'Recursos Humanos': ['director_rrhh', 'gerente_rrhh', 'jefe_rrhh', 'responsable_liquidacion',
